...
export default function Edit({ monitoring }) {
    ...
    const { data, setData, put, processing, reset } = useForm({
        tanggal_persiapan: monitoring.tanggal_persiapan,
        ...
        kondisi_pc: monitoring.kondisi_pc || "Normal",
        kendala_pc: monitoring.kendala_pc || "",
        stl_internet: monitoring.stl_internet || "Normal",
        kendala_internet: monitoring.kendala_internet || "",
        kondisi_input_sdi: monitoring.kondisi_input_sdi || "Normal",
        kendala_sdi: monitoring.kendala_sdi || "",
        jumlah_tegangan_listrik: monitoring.jumlah_tegangan_listrik || 220,
        koneksi_srt: monitoring.koneksi_srt || "Normal",
        kendala_srt: monitoring.kendala_srt || "",
        koneksi_rtmp: monitoring.koneksi_rtmp || "Normal",
        kendala_rtmp: monitoring.kendala_rtmp || "",
        sinyal_audio_video: monitoring.sinyal_audio_video || "Normal",
        kendala_sinyal_av: monitoring.kendala_sinyal_av || "",
        asal_sumber_listrik: monitoring.asal_sumber_listrik || "PLN",
        uji_komunikasi: monitoring.uji_komunikasi || "Sangat Lancar",
        uji_sinyal_av_ke_studio: monitoring.uji_sinyal_av_ke_studio || "Ya",
        hasil_uji_tx: monitoring.hasil_uji_tx || "Sinyal Stabil dan jernih",
        monitoring_kualitas_link: monitoring.monitoring_kualitas_link || "Ya",
        backup_sistem_tx: monitoring.backup_sistem_tx || "Ya",
        catatan_kendala: monitoring.catatan_kendala || "",
        foto: null,
    });
    ...
    const submit = (e) => {
        ...
        put(route('monitoring-live.update', monitoring.id), {
            data: formData,
            forceFormData: true,
            onSuccess: () => {
        ...
        <AuthenticatedLayout
            header={
                <h2 className="text-xl font-semibold text-gray-800">
                    Edit Data Persiapan Siaran Live Lapangan
                </h2>
            }
        >
            <Head title="Edit Data Persiapan Live" />
